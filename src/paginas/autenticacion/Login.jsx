...
export function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-3 sm:p-4 md:p-6">
      {/* Efectos de fondo */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-60 h-60 sm:w-80 sm:h-80 bg-blue-300 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-blob"></div>
        <div className="absolute -bottom-40 -left-40 w-60 h-60 sm:w-80 sm:h-80 bg-purple-300 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-blob animation-delay-2000"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-60 h-60 sm:w-80 sm:h-80 bg-pink-300 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-blob animation-delay-4000"></div>
      </div>

      <div className="w-full max-w-[95%] xs:max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl relative">
        {/* Card principal */}
        <div className="bg-white/80 backdrop-blur-lg rounded-2xl sm:rounded-3xl shadow-2xl p-4 xs:p-6 sm:p-8 border border-white">
          {/* Logo y título */}
          <div className="text-center mb-4 xs:mb-6 sm:mb-8">
            <div className="mb-3 xs:mb-4 sm:mb-6 bg-transparent">
              <img 
                ...
                alt="ContaAPI Logo" 
                className="w-40 h-40 xs:w-48 xs:h-48 sm:w-56 sm:h-56 md:w-64 md:h-64 mx-auto object-contain drop-shadow-lg"
            ...
            <p className="text-sm xs:text-base text-gray-600 mt-1 xs:mt-2 px-2">
          ...
          {mensaje.texto && (
            <div className={`
              mb-4 xs:mb-6 p-3 xs:p-4 rounded-xl text-xs xs:text-sm
          ...
          <form onSubmit={manejarSubmit} className="space-y-3 xs:space-y-4">
            {esRegistro && (
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 xs:pl-10 pr-3 xs:pr-4 py-2.5 xs:py-3 text-sm xs:text-base border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                />
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={manejarCambio}
                className="w-full pl-9 xs:pl-10 pr-10 xs:pr-12 py-2.5 xs:py-3 text-sm xs:text-base border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
              />
              <button
                type="button"
            ...
            {!esRegistro && (
              <div className="text-center">
                <button
                  ...
                  className="text-xs xs:text-sm text-gray-600 hover:text-blue-600 transition-colors"
                >
          ...
          <div className="relative my-4 xs:my-6">
            ...
            <div className="relative flex justify-center text-xs xs:text-sm">
              <span className="px-3 xs:px-4 bg-white text-gray-500">O continúa con</span>
            </div>
          </div>
          ...
          <div className="mt-4 xs:mt-6 text-center">
            <button
              ...
              className="text-xs xs:text-sm sm:text-base text-blue-600 hover:text-blue-700 font-medium transition-colors"
            >
        ...
        {/* Footer */}
        <div className="text-center mt-4 xs:mt-6 text-xs xs:text-sm text-gray-600 px-2">
