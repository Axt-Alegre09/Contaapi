...
export default function GestionEquipo() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm rounded-xl shadow-lg p-6">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400">Administra el equipo de la empresa</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4">
          ...
          <div className="bg-green-50 dark:bg-green-900/30 rounded-lg p-4">
            ...
            <p className="text-2xl font-bold text-green-900 dark:text-green-300">{stats.activos}</p>
          </div>
          <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
          ...
          <div className="bg-red-50 dark:bg-red-900/30 rounded-lg p-4">
            <p className="text-sm text-red-600 dark:text-red-400">Suspendidos</p>
            <p className="text-2xl font-bold text-red-900 dark:text-red-300">{stats.suspendidos}</p>
          </div>
        </div>
      </div>

      {/* Filtros y búsqueda CON DARK MODE */}
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="relative">
            ...
            <select
              ...
              className="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 appearance-none focus:outline-none bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
            >
      ...
      {/* Lista de usuarios CON DARK MODE */}
      {loading ? (
