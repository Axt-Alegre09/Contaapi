  ...
  async obtenerEstadisticas() {
    try {
      ...
      return {
        ...
        propietario: empresas.filter(e => e.rol === 'propietario').length,
        administrador: empresas.filter(e => e.rol === 'administrador').length,
        contador: empresas.filter(e => e.rol === 'contador').length,
